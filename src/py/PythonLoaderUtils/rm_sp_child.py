...
def rm_rcall(func: str, *args, **kwargs) -> Any:
    parentWrite.write(mode='rm_rcall', content={
        'func': func,
        'args': args,
        'kwargs': kwargs
    })
...
def rm_call(func: str, *args, **kwargs) -> Any:
    parentWrite.write(mode='rm_call', content={
        'func': func,
        'args': args,
        'kwargs': kwargs
    })
...
class RainmeterSP:
    ...
    def RmReadString(self, option: str, default: str, replaceMeasures: bool = False) -> str:
